                    ...
                    <form action="{{ route('admin.category.updateCategory') }}" method="POST">
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                ...
                                <input type="text" class="form-control" name="category_id" readonly="" placeholder="Category Code..." value="{{old('category_id')?? $categoryDetail->category_id}}">
                                @error('category_id')
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                ...
                                <textarea id="mytextarea" class="form-control" name="category_description" placeholder="Description..." >{!!old('category_description')?? $categoryDetail->category_description!!}</textarea>
