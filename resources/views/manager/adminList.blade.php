            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav me-auto">
                        <a class="navbar-brand" href="{{ route('admin.listAdmin') }}" ><img src="{{ asset('images/2Tech1.png') }}" alt="logo" class="light-logo2"></a>
                ...
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            ...
                            <a class="has-arrow waves-effect waves-dark active" href="{{ route('admin.listAdmin') }}" aria-expanded="false"><span class="hide-menu">Admin Account</span></a>
