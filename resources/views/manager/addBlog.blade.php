            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse">
                    <ul class="navbar-nav me-auto">
                        <a class="navbar-brand" href="{{ route('admin.blog.index') }}"><img src="{{ asset('images/2Tech.png') }}" alt="logo" class="light-logo2"></a>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <textarea id="mytextarea" class="form-control" name="content" placeholder="Content..." >{{old('content')}}</textarea>
                                    @error('content')
                                        <span style="color: red">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <button type="button" class="btn btn-warning" onclick="window.location.href = '{{ route('admin.blog.draftBlog') }}'">Draft</button>
                        </div>
                        @csrf
                    </form>
                </div>
