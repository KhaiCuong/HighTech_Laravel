                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <a href="{{ route('admin.blog.add') }}" class="btn btn-sm btn-primary pull-left mb-3"><i class="fa fa-plus-circle"></i> Add New</a>
                                        ...
                                        <table class="table product-overview">
                                            ...
                                            <tbody>
                                                @foreach ($blogList as $blog)
                                                    <tr>
                                                        <td>{{$count++}}</td>
                                                        <td><img src="{{ asset('images/blogThumbnail/'.$blog->thumbnail) }}" alt="{{$blog ->title}}"></td>
                                                        <td>{{$blog ->title}}</td>
                                                        {{-- <td>{!!$blog ->content!!}</td> --}}
                                                        <td>{{$blog ->author}}</td>
                                                        @switch($blog->status)
                                                    ...
                                                    {{-- <td>{{ date('d-m-Y', strtotime($blog->created_at))}}</td> --}}
                                                        <td style="width: 7%">
                                                            <div class="button-group">
                                                                ...
                                                                <button type="button" class="btn btn-primary delete" id="{{ $blog->id}}">
