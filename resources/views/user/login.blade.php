									...
									<div class="header-cart">
										...
										<div class="header-cart-dropdown">
											...
											<div class="cart-total-btn">
												...
												<div class="cart-btn">
													<button type="button" onclick="window.location.href = '/cart'" class="btn">checkout</button>
												</div>
											</div>
										</div>
									</div>
		...
		<div class="login-box">
            ...
            <form action="{{ route('userLogin')}}" method="POST">
                ...
                <div class="user-box">
					...
					<a href="{{ route('forgot-password') }}" id="forgotPass">Forgot Password?</a>
                </div>
				<button type="submit"id="login" class="btn btn-infor">
				
					Login
				</button>
                <h6>Don't have an account? <a href="{{ route('register-form') }}" id="register">Register here</a></h6>
            </form>
        </div>
		<!-- Brand Area -->
