                            ...
                            <div class="col-md-12">
                                ...
                                <div class="chart-item table-responsive fix">
                                    <table class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            @endphp
                                                <tr>
                                                    <td class="th-delate"><a href="{{ url('/delete-cart',['id'=>$cart['session_id']]) }}"><i class="fa fa-trash"></i></a></td>
                                                    {{-- <td class="th-delate">
                                                    ...
                                                    <td class="th-product">
                                                        <a href="{{ route('products-details', ['id'=>$cart['product_id']]) }}"><img src="{{ asset('images/'.$cart['product_img']) }}" alt="{{$cart['product_name']}}" style="max-width:50%"></a>
                                                    </td>
                                                    <td class="th-details">
                                                    ...
                                                    <td class="th-qty">
                                                        <input type="number" min="1" max="{{$cart['product_storage']}}" value="{{$cart['product_quantity']}}" class="cart_quantity" name="cart_quantity[{{$cart['session_id']}}]">
                                                    </td>
                                ...
                                <div class="shoping-cart-button">
                                    <div class="cart-button-left">
                                        <button type="button" class="btn custom-button back-to-shopping">Continue Shopping</button>
                                    </div>
                                    <div class="cart-button-right">
                                        <button type="submit" class="btn custom-button" name="update-cart">Update Shopping Cart</button>
                                        <button type="button" class="btn custom-button clear">Clear Shopping Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="shopping-summary chart-all fix">
                                    <div class="shopping-cost-area">
                                        ...
                                        <div class="shiping-cart-button">
                                            <button type="button" class="btn custom-button check-out">Proceed to Checkout</button>
                                        </div>
