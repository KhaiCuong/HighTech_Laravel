								...
								<div class="resestered-customers customer">
									<div class="customer-inner">
										<div class="user-title">
											<h2 style="font-size: 25px">Account Profile</h2>
										</div>
										@if (session('msg'))
											...
											<div class="col-lg-6">
												<div class="account-form">
													<div class="form-goroup">
														...
														<input type="text" readonly="" required="required" class="form-control" value="{{$user->username}}">
													</div>
													<div class="form-goroup">
														<label class="form-label">Customer Name<sup>*</sup></label>
														<input type="text" name="fullname" required="required" class="form-control" value="{{$user->fullname}}">
													</div>
													
													<div class="form-goroup">
														<label class="form-label">Phone Number <sup>*</sup></label>
														<input type="text" name="phone" required="required" class="form-control" value="{{$user->phone}}">
													</div>
													<div class="form-goroup">
														<label class="form-label">Address<sup>*</sup></label>
														<input type="text" name="address" required="required" class="form-control" value="{{$user->address}}">
													</div>
												</div>
											</div>
											<div class="col-lg-6">
												<div class="account-form">
													<div class="form-goroup">
														<label class="form-label">Birthday<sup>*</sup></label>
														<input type="text" name="birthday" id="datepicker" required="required" class="form-control" value="{{$user->birthday}}">
													</div>
													...
													<div class="form-goroup">
														...
														<textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="4">{{$user->description}}</textarea>
													</div>
												</div>
											</div>
											<span style="margin: 5px 0 ">* Required</span>
											<div class="col-lg-6">
												<button class="btn custom-button save" type="submit" style=" ; margin-top: 10px">Save</button>
											</div>
										</div>
