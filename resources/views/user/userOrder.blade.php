						...
						<div class="col-lg-3 col-md-3">
							...
							<div class="">
								...
								<div class="list-group">
									...
									<a class="list-group-item" href="{{ route('user-orders') }}" style="color: #ec4445"><i class="fa fa-pencil fa-fw" aria-hidden="true" ></i>&nbsp; Orders</a>
							...
							<div class="resestered-customers customer">
								<div class="customer-inner">
									<div class="user-title">
										<h2 style="font-size: 25px">History Orders</h2>
									</div>
                                                        ...
                                                        <tr style="cursor: pointer" class="show_detail" data-id="{{$order->order_id}}">
															...
															@switch($order->status)
																@case('0')
																	<td>
																		<div class="button-group">
																			<button type="button" class="btn btn-danger delete-order" id="{{ $order->order_id }}">
																...
																@case('1')
																	<td>
																		<div class="button-group">
																			<button type="button" class="btn btn-info" id="{{ $order->order_id }}">
																...
																@case('2')
																	<td>
																		<div class="button-group">
																			<button type="button" class="btn btn-success" id="{{ $order->order_id }}">
																...
																<table class="table product-overview">
																	...
																	<tbody>
																		...
																		@endphp
																			 ...
																			 <tr>
																				<td>{{$subcount++}}</td>
																				<td><img src="{{ asset('images/'.$order_detail->product_img) }}" alt="{{$order_detail->product_name}}" style="max-width: 50%;"></td>
